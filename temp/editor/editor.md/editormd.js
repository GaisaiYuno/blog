...
;(function(factory) {
    ...
    editormd.defaults     = {
        ...
        editorTheme          : "elegant",      // Editor area, this is CodeMirror theme at v1.5.0
    ...
    editormd.markedRenderer = function(markdownToC, options) {
        ...
        markedRenderer.paragraph = function(text) {
			...
			var isTeXLine       = false;
			console.log("Inline "+isTeXInline+",Line "+isTeXLine);
            // var isTeXInline     = /\$\$(.*)\$\$/g.test(text);
			// var isTeXLine       = /^\$\$(.*)\$\$$/.test(text);
            ...
            {
				while (text.indexOf("<em>")!=-1) text=text.replace("<em>","_");
				while (text.indexOf("</em>")!=-1) text=text.replace("</em>","_");
			...
			console.log("Parased Result "+text);
